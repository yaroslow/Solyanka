...
### Packages:
  ...
  | --------------------------------------------------------------------- | --------- |
  |                                 `Core`                                |  |
  | Solyanka.Cqs                                                          | [![Build status](https://github.com/yaroslow/Solyanka/actions/workflows/Core.Solyanka.Cqrs.yml/badge.svg)](https://github.com/yaroslow/Solyanka/actions/workflows/Core.Solyanka.Cqrs.yml) [![NuGet](https://img.shields.io/nuget/dt/Solyanka.Cqs.Abstractions)](https://www.nuget.org/packages/Solyanka.Cqs.Abstractions) [![NuGet](https://img.shields.io/nuget/v/Solyanka.Cqs.Abstractions)](https://www.nuget.org/packages/Solyanka.Cqs.Abstractions) |
